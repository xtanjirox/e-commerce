...
function customCheckColor(){
	...
	if (logoHeader !== "white") {
		$('.logo-header .navbar-brand').attr('src', 'https://www.cfnews.net/var/cfnews/storage/images/mediatheque/hd/standard-hd/logos/data-impact-art-logo-2018/8996618-1-fre-FR/Data-Impact-ART-LOGO-2018.png');
	} else {
		$('.logo-header .navbar-brand').attr('src', 'https://www.cfnews.net/var/cfnews/storage/images/mediatheque/hd/standard-hd/logos/data-impact-art-logo-2018/8996618-1-fre-FR/Data-Impact-ART-LOGO-2018.png');
	}
}
